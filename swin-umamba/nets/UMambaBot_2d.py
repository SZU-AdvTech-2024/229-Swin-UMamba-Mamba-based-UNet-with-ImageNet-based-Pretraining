...
if __name__ == '__main__':
    model = umamba_bot_model().cuda()
    input = torch.randn(2, 3, 256, 256).cuda()
    predict = model(input)
    print("len:", len(predict))
    print("shape", [o.shape for o in predict])  #torch.Size([2, 1, 256, 256]), torch.Size([2, 1, 128, 128]), torch.Size([2, 1, 64, 64]),
    # torch.Size([2, 1, 32, 32]), torch.Size([2, 1, 16, 16]), torch.Size([2, 1, 8, 8])