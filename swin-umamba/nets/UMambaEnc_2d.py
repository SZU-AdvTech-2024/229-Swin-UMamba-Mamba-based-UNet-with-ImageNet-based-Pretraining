...
if __name__ == '__main__':
    model = umamba_enc_model().cuda()
    input = torch.randn(2, 3, 256, 256).cuda()
    predict = model(input)
    print("len:", len(predict))
    print("shape", [o.shape for o in predict])  #[torch.Size([1, 256, 256]), torch.Size([1, 256, 256])]

    # feature_map_sizes: [[256, 256], [128, 128], [64, 64], [32, 32], [16, 16], [8, 8], [4, 4]]
    # do_channel_token: [False, False, False, False, True, True, True]
    # MambaLayer: dim: 32
    # MambaLayer: dim: 128
    # MambaLayer: dim: 256
    # MambaLayer: dim: 16
