...
if __name__ == '__main__':
    folder = "/home/cwq/MedicalDP/SwinUmamba/data/nnUNet_preprocessed/Dataset703_NeurIPSCell/nnUNetPlans_2d"
    ds = nnUNetDataset(folder, None, 953)  # this should not load the properties!
    dl = nnUNetDataLoader2D(ds, 2, (512, 512), (32, 32), 0.33, None, None)
    a = next(dl)
